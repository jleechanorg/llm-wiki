...
Welcome to Beads! This repository uses **beads_rust** (`br`) for issue tracking — a modern, AI-native tool stored directly in your codebase alongside your code.
...
- **SQLite-backed**: Fast local queries via `.beads/beads.db`
...
- **Config**: `.beads/config.yaml` — project-specific settings
