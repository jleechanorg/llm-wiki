---
name: green-pipeline-mechanics
description: "How to drive a worldarchitect.ai PR to 7-green manually — skeptic verdict plumbing, Gate 6 body-URL rule, PR-attached vs dispatch green-gate runs, world_logic line budget"
metadata: 
  node_type: memory
  type: project
