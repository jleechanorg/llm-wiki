---
name: feedback-2026-06-10-response-body-swallowed
description: "Footer-only replies correlate with `claude-fable-5` model echoing harness-injected git-header tool_result (from Enter-without-typing); rule in CLAUDE.md is correlative, not causal — first seen 2026-06-10"
metadata:
  node_type: memory
  type: feedback
  originSessionId: 1661306a-6dd5-4607-9d0a-cfafb14b134a
---
