---
name: multi-level-organic-progression-real-root-cause
description: "multi_level_organic_progression 2→3 failure root cause is MIXED, not pure prompt. LLM correctly writes level: 3 in state_updates; backend clobbers. PR-B in PR #7434 fixes 4/6 failures; remaining \"got level 2\" needs separate investigation."
metadata: 
  node_type: memory
  type: project
