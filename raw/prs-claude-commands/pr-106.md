# PR #106: Claude Commands Export 2025-11-22: Directory Exclusions Applied

**Repo:** jleechanorg/claude-commands
**Merged:** 2025-11-23
**Author:** jleechan2015
**Stats:** +5523/-436 in 25 files
...
- **🧠 20 Skills**: Reference knowledge exports (.claude/skills/)
...
> [!NOTE]
> Adds unified browser automation and hardens PR processing with conflict docs, quality gates, validation hooks, and MCP setup tweaks (Playwright off by default).
> 
> - **Commands**:
>   - **/browser**: Unified automation selecting Playwright vs Supe
