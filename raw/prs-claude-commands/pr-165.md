# PR #165: Claude Commands Export 2025-12-11: Directory Exclusions Applied

**Repo:** jleechanorg/claude-commands
**Merged:** 2025-12-11
**Author:** jleechan2015
**Stats:** +5768/-1780 in 87 files
...
- **🧠 24 Skills**: Reference knowledge exports (.claude/skills/)
...
> [!NOTE]
> Refactors export/packaging (adds `automation/`, generic exporters, path/auth fixes), overhauls `/copilot‑lite` with a strict local‑first workflow, adds Gemini CLI and orchestration/test hardening, improves git‑header and scripts, and t
