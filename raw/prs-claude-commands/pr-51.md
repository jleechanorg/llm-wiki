# PR #51: Claude Commands Export 2025-09-28: Directory Exclusions Applied

**Repo:** jleechanorg/claude-commands
**Merged:** 2025-09-28
**Author:** jleechan2015
**Stats:** +1444/-333 in 25 files
...
- **📎 36 Hooks**: Essential Claude Code workflow automation
...
> [!NOTE]
> Adds new /gen(e) and Spec Kit commands, hardens Cerebras pipeline and tests, improves PR/CI status parsing and multi-search, refines command composition hook, updates MCP installer, and refreshes docs.
> 
> - **Commands**:
>   - **New**: `/gen` (alias to proto genesis), `/gene` (auto-exec genesis with orchestration), `/runlocal`, Spec Kit suite (`/sp
