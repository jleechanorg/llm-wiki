# PR #229: Claude Commands Export 2026-01-30: Directory Exclusions Applied

**Repo:** jleechanorg/claude-commands
**Merged:** 2026-01-31
**Author:** jleechan2015
**Stats:** +1968/-552 in 25 files
...
- **📎 49 Hooks**: Essential Claude Code workflow automation
...
> [!NOTE]
> **Medium Risk**
> Touches automation that posts comments/updates externally (GitHub + Moltbook) and changes retry/idempotency and parallel dispatch safety logic, so misclassification could cause missed or duplicate actions despite adde
