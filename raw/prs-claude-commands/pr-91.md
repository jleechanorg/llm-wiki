# PR #91: Claude Commands Export 2025-10-26: Directory Exclusions Applied

**Repo:** jleechanorg/claude-commands
**Merged:** 2025-10-27
**Author:** jleechan2015
**Stats:** +6942/-127 in 27 files
...
- **🚀 23 Scripts**: Development environment management (scripts/ directory)
...
> [!NOTE]
> Introduces the multi-model second opinion command with auth/CLI, unifies export config and adds skills/Node deps to exports, and ships new MCP launchers/installer plus settings and README updates.
> 
> - **Commands and Skills**:
>   - Add `second_opi
