# PR #223: Claude Commands Export 2026-01-09: Directory Exclusions Applied

**Repo:** jleechanorg/claude-commands
**Merged:** 2026-01-10
**Author:** jleechan2015
**Stats:** +5486/-1418 in 58 files
...
- **🧠 34 Skills**: Reference knowledge exports (.claude/skills/)
...
> [!NOTE]
> Major updates to automation, evidence, and docs.
> 
> - **Automation:** Workflow-specific comment limits (PR automation, fix-comment, codex update, fixpr) with CLI flags; improved safety manager (config overrides, email/keyring config,
