# PR #191: Claude Commands Export 2025-12-16: Directory Exclusions Applied
...
> [!NOTE]
> Adds review-body comment support and idempotent reply checks to comment posting, strengthens copilot-lite fetching/verification, updates cursor tests, and refreshes README release notes.
> 
> - **Commands (/commentreply)**:
>   - Fetch
