# PR #101: Claude Commands Export 2025-11-08: Directory Exclusions Applied

**Repo:** jleechanorg/claude-commands
**Merged:** 2025-11-09
**Author:** jleechan2015
**Stats:** +1532/-171 in 12 files
...
> [!NOTE]
> Adds /automation for GitHub PR automation, retargets /processmsgs to MCP Agent Mail, strengthens /redgreen test-first workflow, improves CLI selection, and adds Beads MCP server support with expanded orchestration docs.
> 
> - **Commands**:
>   - **N
