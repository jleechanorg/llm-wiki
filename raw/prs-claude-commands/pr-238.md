# PR #238: Claude Commands Export 2026-02-09: Directory Exclusions Applied

**Repo:** jleechanorg/claude-commands
**Merged:** 2026-02-10
**Author:** jleechan2015
**Stats:** +1106/-422 in 17 files
...
- **🧠 56 Skills**: Reference knowledge exports (.claude/skills/)
...
> [!NOTE]
> **Medium Risk**
> Changes core PR automation gating and orchestration execution/worktree behavior, which can alter when comments are posted and how agents run. Risk is mitigated by added tests, but behavior changes may affect existing 
