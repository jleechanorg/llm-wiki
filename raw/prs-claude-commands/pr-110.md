# PR #110: Claude Commands Export 2025-11-25: Directory Exclusions Applied

**Repo:** jleechanorg/claude-commands
**Merged:** 2025-11-26
**Author:** jleechan2015
**Stats:** +2385/-101 in 16 files
...
> [!NOTE]
> Adds Pair Protocol docs/command, refines export behavior (stop excluding `automation/`), hardens MCP installers, routes local MCP scripts to ~/.claude, and adds ddg-search plus skills/docs updates.
> 
> - **Commands/Docs**:
>   - Add `/.claude/commands/pair.md`, `pair-protocol.md`, and `pair-examples.md`
