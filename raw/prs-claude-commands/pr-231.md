# PR #231: Claude Commands Export 2026-02-04: Directory Exclusions Applied

**Repo:** jleechanorg/claude-commands
**Merged:** 2026-02-04
**Author:** jleechan2015
**Stats:** +3804/-2449 in 59 files
...
> [!NOTE]
> **Medium Risk**
> Touches automation workflows that post to GitHub and enforce run limits; behavior changes (single-comment replies, rolling-window counters, relaxed comment validation) could affect coverage guarantees or rate-limit/lo
