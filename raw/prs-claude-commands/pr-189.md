# PR #189: Claude Commands Export 2025-12-16: Directory Exclusions Applied

**Repo:** jleechanorg/claude-commands
**Merged:** 2025-12-17
**Author:** jleechan2015
**Stats:** +39/-9 in 2 files
...
> [!NOTE]
> Standardizes fallback comment fetching to match `commentfetch.py` (typed `{comments: [...]}`) and updates counting by `.type`; adds a new v1.1.0 entry to README.
> 
> - **`/copilot-lite` command**:
>   - **Fallback comment fetch**: Add
