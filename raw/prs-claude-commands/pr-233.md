# PR #233: Claude Commands Export 2026-02-04: Directory Exclusions Applied

**Repo:** jleechanorg/claude-commands
**Merged:** 2026-02-04
**Author:** jleechan2015
**Stats:** +693/-676 in 19 files
...
> [!NOTE]
> **Medium Risk**
> Moderate risk because it changes safety-limit accounting (global run counting/normalization and timestamp parsing) and updates CI publishing/auth configuration; mistakes could block automation runs or break releases.
