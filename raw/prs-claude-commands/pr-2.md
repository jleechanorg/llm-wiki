# PR #2: Claude Commands Export 2025-08-27: Directory Exclusions Applied

**Repo:** jleechanorg/claude-commands
**Merged:** 2025-08-27
**Author:** jleechan2015
**Stats:** +620/-488 in 5 files
...
* New Features
  * Added CLI flag to switch between code-generation and documentation prompts.
  * Enabled branch-aware output saving with timestamped files and on-screen path summary.
  * Introduced optional MCP servers (Playwright, React, iOS Simulator, GitHub) gated by environment flags.
  * Added ba
