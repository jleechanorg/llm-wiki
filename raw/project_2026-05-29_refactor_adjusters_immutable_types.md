---
name: Refactor backend adjustment registry to immutable types and validations
description: Capture patterns for breaking circular imports, implementing immutable validations, and providing backward-compatible shim interfaces
type: project
bead: rev-xetuw
---

# Refactor Backend Adjustment Registry to Immutable Types and Strict Validations
