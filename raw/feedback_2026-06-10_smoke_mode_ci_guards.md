---
name: smoke-mode-routing-ci-guards
description: Three CI guards added to prevent silent /smoke→mock regression; runtime assertion + two grep gates in smoke-mode-routing-contract job
metadata: 
  node_type: memory
  type: feedback
  bead: rev-k8jq1
  originSessionId: 8a9e1cf0-2a40-4b2e-a82d-d8c0f9cf0186
---
