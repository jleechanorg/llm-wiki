---
name: cr-incremental-after-mention-takes-15min
description: CodeRabbit incremental review after @-mention ping takes 5-15 minutes; plan waiting time accordingly when using it to clear stale CHANGES_REQUESTED
metadata: 
  node_type: memory
  type: feedback
