---
name: level-up-2-3-routing-backend-reads-legacy-llm-writes-canonical
description: Multi-level organic progression 2->3 finish turn regression root cause; routing falls through to CombatAgent because backend consults legacy custom_campaign_state.level_up_* flags that LLM correctly no longer writes
metadata: 
  node_type: memory
  type: project
  bead: "rev-froz1, rev-mutst1"
