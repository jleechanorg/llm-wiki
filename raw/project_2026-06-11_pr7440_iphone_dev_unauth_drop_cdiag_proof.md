---
name: pr7440-iphone-dev-unauth-drop-cdiag-proof
description: "User said \"issue on dev, then switched to load s1 and it worked\" — cdiag proved the actual bug is /api/constants/models 401 firing before Firebase auth has resolved the user, not a cross-hostname auth problem"
metadata: 
  node_type: memory
  type: project
