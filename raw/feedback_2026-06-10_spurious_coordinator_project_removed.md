---
name: spurious-coordinator-project-removed-from-hermes-agent-orchestrator-yaml
description: "Accidental ao start <worktree-path> created a 48-line \"coordinator\" project; deleted, backed up, root cause = config-canonicalization gap"
metadata: 
  node_type: memory
  type: feedback
  bead: bd-st2r
