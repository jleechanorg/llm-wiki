---
name: feedback-2026-06-10-sdk-mock-is-synthetic-llm
description: "Mocking gemini_provider.get_client (in-process) is NOT mocking at external API boundary — the LLM chunks are still synthetic; the rule 'mocks only at external API boundaries' means the network socket, not the in-process wrapper"
metadata: 
  node_type: memory
  type: feedback
