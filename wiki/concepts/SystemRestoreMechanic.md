...
- [nocturne-bg3-v6-bug-repro-test-campaign](../sources/nocturne-bg3-v6-bug-repro-test-campaign.md): The campaign specifically tests SYSTEM RESTORE functionality. Character verification and game state restoration are performed at the start of the session to ensure accurate testing conditions
...
## Connections
- [NocturneSosukeBugRepro](../entities/NocturneSosukeBugRepro.md) — character used in testing
- [ShatteredSanctum](../entities/ShatteredSanctum.md) — location where testing occurs