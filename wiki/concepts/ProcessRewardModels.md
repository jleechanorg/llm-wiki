...
PRM provides the step-level grounding that makes [ExtendedThinking](ExtendedThinking.md) more efficient:
...
- [ExtendedThinking](ExtendedThinking.md) — PRM is what makes extended thinking efficient
- [ReasoningBudget](ReasoningBudget.md) — PRM helps allocate reasoning budget to the right paths
- [SelfCritique](SelfCritique.md) — PRM can be viewed as automated step-level critique
- [VerificationLoop](VerificationLoop.md) — PRM provides the internal verification signal before external tests
- [TestTimeCompute](TestTimeCompute.md) — PRM enables smarter allocation of test-time compute

## See Also

- [SelfCritique](SelfCritique.md) — manual step-level critique (human or LLM)
- [ExtendedThinking](ExtendedThinking.md) — where PRM signals are consumed at inference time
- [DeterministicFeedbackLoops](DeterministicFeedbackLoops.md) — PRM as an automated feedback signal
