...
This pattern was observed and applied consistently across oracle batches 1 and 2: PRs #6164, #6153, #6147, #6136, and #6134 all received "ok" verdicts based on net-negative deletion alone. The oracle does not apply a minimum-size floor for deletions the way it applies a maximum-size ceiling for additions. [jeffrey-oracle](../syntheses/jeffrey-oracle.md)
