...
## Connections
- [MetaHarness](MetaHarness.md) — harness code IS context window management code; Meta-Harness searches over what context to present, not just how to fit it within window limits
