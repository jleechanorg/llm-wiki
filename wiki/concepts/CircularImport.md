...
1. **StreamEvent**: Extracted into a small "dependency leaf" module to break the cycle between [StreamingOrchestrator](StreamingOrchestrator.md) and [LlmService](LlmService.md).
