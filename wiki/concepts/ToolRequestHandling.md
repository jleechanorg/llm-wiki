...
## Related Pages
- [llm-provider-tool-request-tests](../sources/llm-provider-tool-request-tests.md) — tests validating this concept
- [Cerebras](../entities/Cerebras.md) — supports tool requests for dice rolling
- [OpenRouter](../entities/OpenRouter.md) — supports tool requests for function calling
