...
SOP (Standardized Operating Procedures) Encoding is a pattern where human workflows are encoded as agent prompts or process sequences. [MetaGPT](MetaGPT.md) is the canonical example — it assigns diverse roles to agents based on SOPs to reduce cascading hallucinations.
