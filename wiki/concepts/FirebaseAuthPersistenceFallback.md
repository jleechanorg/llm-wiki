...
1. **`indexedDBLocalPersistence`** — IndexedDB-backed; HANGS on iOS WebKit after OS process suspension (see [WebKitIndexedDBHangDeadlock](WebKitIndexedDBHangDeadlock.md))
...
## Correct fix (from [PR7720](../entities/PR7720.md))
