...
## [2026-08-04] ingest | The Serpent-King Among the Rats — Nocturne × Witcher S4 campaign

Key claims: Third Nocturne incarnation (after Ravencrest and Zhentarim Silent Blade) — College of Swords Bard embedded with the Rats (Giselher, Mistle, Kayleigh, Reef) in the Witcher Season 4 era. Personality is an explicit four-way composite (Griffith/Tywin/Aizen/Johan) labeled the Serpent-King archetype: two masks (Quiet Rat data-probe layer + Dispassionate Strategist), three drives (portable absolute power, surgical domination, supremacist certainty). Continuous with the god-campaign apotheosis line (MaskedPowerSmurfing, ProjectApotheosis) — same masked-capability + transcendence-over-throne architecture at mortal scale. New pages: 10 entities (incl. TheRats, TheWitcher, Griffith, TywinLannister, JohanLiebert), 5 concepts (SerpentKingArchetype, DataProbeSocialEngineering, PortableAbsolutePower, SurgicalDomination, MundaneIllusionDisguise).

## [2026-08-04] ingest | WorldAI Campaign Prompts — master prompt index: Shadowheart Sharran leader + Gladius merc brute

Key claims: working index of Nocturne-line campaign prompts plus two full prompts. (1) Shadowheart post-BG3: sided with Shar, level 12 (Paladin 5/Death Cleric 7), leads the Sharran sect, best-in-slot BG3 gear, guided character creation with spoiler-free plot-arc choices, accumulation goals (power/wealth/influence/networks/companions). (2) Gladius: 18-year-old evil-ESFP brute merc in post-BG3 Baldur's Gate, L5 paladin with the Oath of Self-Perfection (Apex Paladin) homebrew — EP-powered Perfected Strike, Aura of Unyielding Dominance, Apex Senses, Willpower Infusion; destiny ruleset with 5e fallback; consent-gated one-year time skips with autonomous off-screen simulation. New entities: Gladius, Shar. New concepts: OathOfSelfPerfection, TimeSkipConsent, DestinyRuleset. Contradictions logged: class titled "Nocturne's Class" attached to Gladius; INT-keyed class on an explicitly low-INT character; source truncated mid-feature.

## [2026-08-04] ingest | The Eagle's Brood: The Serpent & The Sun — Pax Julia campaign guide (Gaia Julia world of Rome)

Key claims: Alt-history bible for the Gaia Julia Rome campaign line. Point of divergence: Day of Ascension, 44 BCE — the Ides of March assassination fails via a Fated Miasma vision; Republic suspended. Caesar marries Cleopatra VII, legitimizes Caesarion (Lex de Filio Aegypto, 43 BCE), has Gaius Octavius killed (42 BCE), conquers Parthia with Antony, is deified as Divus Julius (29 BCE), dies of old age 14 BCE. Caesarion's Golden Age (14 BCE–10 AD): Alexandria second capital, Cult of Serapis-Jupiter state religion. Fated Miasma prophecy-curse intensifies each generation and passes with the throne under primogeniture. Source truncates mid-passage during Caesarion's decline (~10–25 AD); dynasty named through 56 AD but not covered. New entities: GaiusJuliusCaesar, CleopatraVII, Caesarion, MarkAntony, GaiusOctavius, Alexandria. New concepts: FatedMiasma, LexDeFilioAegypto, DayOfAscension, CultOfSerapisJupiter.

## [2026-08-04] ingest | God Campaign Prompt Upgrade V0 — Divine Deception Protocol

Key claims: DM system-prompt draft for a Forgotten Realms (BG3 era) campaign where the player is a Rank A deity smurfing in the divine bracket. Engine tracks Public vs True reality; four identity layers (Mortal Shell / False Deity Rank Y / Primary Mask Rank Z / Hidden Truth Rank A) with free-action switching; hidden 0-100% Divine Dissonance meter (triggers: metric mismatch, probability violation, direct observation; thresholds: 20/50/80 escalating from wild-magic dismissal through Oghma/Savras scrying and Inevitable/Solar dispatch to Pantheon exposure); quantified per-rank stat table (True Rank A: DH 180+, DAC 25+, 200+ DPP, +12 auto-hit) capped by infinite-stats Ao, who quietly sanctions the hidden truth in service of 'Absolute Codification'. Section V truncated mid-sentence. New entities: Helm, Oghma, Savras. New concepts: FourLayersOfExistence, QuantifiedDivineReferenceTable. Updated: Ao, Mystra, Shar, DivineDissonance, DivineDeceptionProtocol, MaskedPowerSmurfing. Contradiction logged: 3-layer vs 4-layer protocol numbering.

## [2026-08-04] ingest | God of Murder — The Sanguine Architecture (God Mechanics V1+V2)

Key claims: canonical single-source spec (compiled 2026-07-21 from worktree wa-god-mechanics-v2) stitches the BG3 campaign bible + V1 general god-mechanics (7-rank ladder) + V2 general overlay (hidden bands, auto-win ladder, per-dawn menu, deicide-cost) + Nocturne V2 5e specialization. Protagonist: female Dark Urge, gestalt Gloomstalker/Assassin L12, drained the Netherbrain + Crown of Karsus and consumed Bhaal's spark; rules Baldur's Gate via Submissive Death + Tragic Betrayal; arc = Quasi-Deity → Greater Goddess pantheon deicide. Provenance: 7-pass Gemini design log (share Td7fA4pzuvMs, final 3,422-word regeneration), banned-name audit clean (1 false positive on 'echo'), live PR #8488 (4 commits, 8 files, +1865/-0, OPEN). New entities: DarkUrge, Bhaal, Netherbrain, PR8488. New concepts: SanguineArchitecture, SubmissiveDeath, GodMechanicsSevenRankLadder, GodMechanicsV2Overlay, DeicideCost. Source truncated after Module 0 opening; Parts 2–4 summarized from the compilation's own TOC/part headers.

## [2026-08-04] ingest | The Silent Blade — Nocturne merc Zhentarim campaign

Key claims: New Nocturne incarnation (third in line after Ravencrest/Sosuke variants): 19yo Zhentarim mercenary, Ranger (Gloom Stalker) L5, Haunted One/Disgraced Noble, operating in rebuilding Baldur's Gate. Design core: VenomousOrchid dual-mask archetype (Gilded Spider seductress / Butcher in the Dark terror operative), WeaponizedIntimacy (flirtation as tactical recon), and the JohanExperiment compulsion (seduce moral paragons, execute them when they fail — 'civilization is a lie', named for Monster's Johan Liebert). Second consecutive Gloom Stalker ingest after Visenya v9, confirming ambush-predator chassis preference. Created entities: NocturneSilentBlade, Zhentarim (update), BaldursGate (update). Created concepts: VenomousOrchid, WeaponizedIntimacy, JohanExperiment, GloomStalkerConclave.

## [2026-08-04] ingest | The Sovereign Protocol — Multiversal Campaign Upgrade system prompt

Key claims: Reusable system directive (not a campaign bible) that upgrades any in-progress single-universe campaign to god-tier multiversal scope while retaining PC identity/allies/history. PC becomes a Terminal Administrator among 1,000 ranked Sovereigns in the Pan-Substrate. Mechanics: theme-derived Sovereign Logic; SP metric (1 SP = 1,000 universes) triple-functioning as territory/currency/HP with GP as check modifier; Aggro Meter (0-10) pricing expansion speed in Emperor hostility, opening at Lethal 8/10; Logic Siege ideology combat (d20 + GP + SP vs Defense, failure = Logic Rot SP damage); Peer Handshake merging of alternate-self Mirrors (+10% SP or Aggro rise); Entropy Reversal endgame (rewrite thermodynamics multiverse-wide). Hierarchy: Emperors 1-10 / Conductors 11-100 / Administrators 101-1000; PC org becomes a Hegemony; existing NPCs elevated to Sub-Deities with history-matched portfolios. New pages: 2 entities (PanSubstrate, Sovereign), 8 concepts (SovereignLogic, SubstratePointMetric, LogicSiege, AggroMeter, PeerHandshake, EntropyReversal, SovereignHierarchy, SubDeity).

## [2026-08-04] ingest | The Pax Caesara: Architect of the Golden Cage (Gaia Julia v7)

Key claims: Seventh Gaia Julia campaign bible; 44 BCE Pax Caesara timeline (Caesar survived the Ides via Venus blood, Republic crushed, world pacified and 'boring'). Gaia rebuilt as ENTJ Decadent Conqueror 'Vibia' on a new SovereignVoiceClass (Eloquence Bard, componentless Auctoritas casting, 30-level Prodigy→Manipulator→Demagogue progression, Magical Secrets = Wall of Force/Modify Memory/Mass Suggestion). New compulsion mechanic PriceOfDefiance (CHA Disadvantage vs unpunished defiers; Inspiration + Temp HP = CHA for breaking wills). New entities Caesarion and Batiatus; updated GaiaJuliaCaesar and Auctoritas pages. Contradictions logged: v3/v6 persona-setting merge, Caesarion's age, Batiatus chronology. Document truncates mid-level-14 ('Infecti…').

## [2026-08-04] ingest | Campaign Visenya v9 — The Blood Dragon Apex Stalker (209 AC)

Key claims: Ninth Visenya frame relocates the protagonist to the Dunk & Egg era — 16-year-old daughter of Maekar Targaryen under the dying Daeron II, awarded Rook's Rest barony for a one-season bandit purge, feared as 'the Blood Dragon.' Build pivots from v6's bard/mastermind to a Level 6 Gloom Stalker Ranger / Assassin Rogue gestalt ('Apex Stalker') optimized for darkness supremacy and round-one alpha strikes. New homebrew: Stress-Line Sight, a 5-tier predictive-perception ladder (Cub 15 ft → Demi-God 480 ft/unlimited) whose top tier opens 'the First Song's prison door' via a Section 13 Magic Barrier System not in this excerpt. Title card commits to four emergent endings with player-chosen resolution. Entities: VisenyaTargaryen (updated), MaekarTargaryen, DaeronIITargaryen, RooksRest, AshfordTourney. Concepts: ApexStalker, StressLineSight, FourEmergentEndings.

## [2026-08-04] ingest | Rivellon Under the Emerald Eclipse — DOS2 Gestalt Tier-4 god-slayer anthology

Key claims: Post-DOS2 tyranny-ending campaign — PC consumed Lucian the Divine + Dallis the Hammer at the First Garden and now solely anchors the Veil (VeilMonopoly). Chassis: L12→30 gestalt (Oath of Conquest Paladin × Source Soul Sorcerer, both full progressions simultaneously), 12d12 Tyrant Divine hit dice, CHA 20 / DEX 18, AC 19, spell DC 17, Stealth +12. Custom unlock column per level: Source Vision/Sightless Eye (permanent True Seeing 120ft + 1-mile Source tracking), Immaculate Presence, Source Smite (SP-fueled Necrotic/Force conversion), Veil Striker (+2d8 from stealth), Cleansing Shadow (shadow teleport), Dark Pinions (60ft fly). Source truncates mid-L15. Created 4 entities (Rivellon, LucianTheDivine, DallisTheHammer, DivinityOriginalSin2) + 6 concepts (GestaltTier4Progression, SourceSoulSorcerer, SourceSmite, ImmaculatePresence, VeilMonopoly, TheSovereignLedger). Pattern note: third distinct power-floor experiment in the collection (L12 epic start vs Ains L12-16 ceiling vs Visenya v6 L6 prodigy); reconfirms taste profile of stealth-charisma apex predator + IP adaptation into D&D hybrid rules.

## [2026-08-04] ingest | Campaign Template prompt v3 — the 'Sovereign Solo' Campaign Bible generator master prompt

Key claims: This is a meta-document — the reusable master prompt (v3, with a v2 'Sovereign Solo'/'God-Mode' fragment) that generates the wiki's campaign bibles. Mandates a nine-section structure: power-fantasy intro, masked protagonist with a Core Compulsion mechanic (failure penalty / success bonus), renamed Gestalt class with a game-breaking unique ability (names 'Auctoritas' as an example), assets + 3-NPC retinue, Viper's Nest family (2 Titan parents + exactly 2 older brothers + 2 older sisters, each with a Mask and Rival/Ally/Pawn dynamic), 10/10/10 faction blocks with exploitable Hooks, world lore with an explicit Divergence Point, gazetteer with hazards + 2 custom mechanics + 8-relic loot table, and an A/B/C authority-demonstrating opening scene. Explains the shared skeleton across Visenya v5–v8 and the Ains Overlord module. New entity: CampaignTemplate. New concepts: CampaignBibleNineSectionStructure, SovereignSoloCampaignGenerator, CoreCompulsionMechanic, MasksPublicFaceTrueNature, VipersNestFamilyStructure.

## [2026-08-04] ingest | The Bleeding Dragon (298 AC) — campaign Visenya v5

Key claims: Fifth Visenya campaign variant — Rhaegar-wins alternate history where the Trident victory yields The Long Discord, a 15-year Forever War with a bankrupt junta on the Iron Throne. Visenya reboots as a 12-year-old Apex daughter of Rhaegar × Vaela Baelarys (vanished Volantene sorceress). Divergences: Sack that Wasn't (Tywin Hand-for-life), Aerys imprisoned in the Maidenvault with wildfire latent, Jon legitimized as Jaehaerys, North sealed by the Ceasefire of Bones under Eddard Stark, dragons extinct but Dragonpit partially rebuilt. New entities: RhaegarTargaryen, VaelaBaelarys, EddardStark, TywinLannister, JaehaerysTargaryen, AerysIITargaryen, HouseBaelarys, ViserysTargaryen (v5). New concepts: TheLongDiscord, TheGrinding, CeasefireOfBones, SackThatWasnt. Contradictions logged: per-version protagonist reboot (v4 vs v5), Baelarys/Belaerys spelling split, 286/287 AC date tension.

## [2026-08-04] ingest | The Winter Web: A Blood Dragon's Vacation — Visenya v6 campaign bible (Part 1)

Key claims: v6 repositions Visenya Targaryen as a 14-year-old Level 6 Apex Weaver (Bard/Mastermind Gestalt) in an alt-history where Rhaegar won the Trident 17 years prior; she travels the North incognito as 'Lady Elyse Celtigar' to vivisect Stark loyalties. New mechanics: Entropy Toll (Exhaustion for tolerating lies, temp HP for shattering egos), Static Field (temperature-drop aura, auto-failed insight vs her lies, Stealth disadvantage), Information Geometry power source, Sadism Dice, spirit dragon Entropy manifestable as a Large Drake. Created 7 entity pages (VisenyaTargaryen update, RobbStark, JonSnow, RhaegarTargaryen, CatelynStark, Blackguard, EntropyDrake) and 6 concept pages (ApexWeaver, EntropyToll, StaticField, InformationGeometry, SadismDice, ForeverWarColdWar). Noted version drift: age 16→14, INTJ→ENTJ, Belaerys→Baelarys spelling across the v2-v6 campaign line. Source truncates mid-Tier-3 ('The Devo...'); Part 2 expected.

## [2026-08-04] ingest | Campaign Visenya v8 — Section 8 Gazetteer: The Nightfort, Sovereign Shadow Tracker, and the Draconic Scarcity Ledger

Key claims: Dance-era continuation section for the Visenya campaign line. (1) Nightfort Ruins gazetteer entry with the Primordial Cold hazard (DC 16 CON per 10 min, 2d6 cold + Exhaustion). (2) Sovereign Shadow Tracker: SP = spies×2 + blackmail caches×10 + subverted officers×15 − disclosures×20, four tiers culminating in 'The Terminal Administrator' (subversion DC baseline 5). (3) Draconic Command & Scarcity Ledger: dragon Vermithrax costs 1,000gp/month, DC 14 CHA command checks (+4 Sovereior Singularity [sic]), and a Famine-of-Fire failure state that triggers a Jacaerys counter-audit. (4) d10 'Relics of the Sowing' loot table (truncated at entry 7). New entities: Vermithrax, TheNightfort, JacaerysVelaryon, HouseCeltigar. New concepts: SovereignShadowTracker, DraconicScarcityLedger. Contradiction flagged: Vermithrax (v8) vs Vermithor (v3).

## [2026-08-04] ingest | Visenya v7 — Daemon's Great Bastard claims a dragon for the Blacks

Key claims: (1) 7th reframe of the Visenya campaign line: player character is now the bastard daughter of Daemon Targaryen and a dead Targaryen lady, making her a Great Bastard with dragonlord blood on both sides. (2) Age 16, conspicuous true-Valyrian royal features that broadcast the royalty her bastard status denies. (3) Opening scene set immediately after she claims a medium-sized dragon, joining Rhaenyra's Blacks as a serious battle power (Dance of the Dragons, ~129 AC). New entity pages: VisenyaWaters (version-scoped to avoid clobbering VisenyaTargaryen/VisenyaBelaerys), DaemonTargaryen, RhaenyraTargaryen. New concepts: GreatBastard, DragonClaiming, ValyrianFeaturesAsStatus. Cross-version parentage contradiction logged as intentional alternate framing.

## [2026-08-04] ingest | Visenya v4 — The Uncrowned Queen (Dunk & Egg, 209 AC)

Key claims: Visenya Targaryen (16, daughter of Maekar, sister to Egg) is secretly the last scion of House Baelarys, Valyrian 'Apex Conductor' God-Mages who bound the dragons; her Apex blood grants geometric perfection and near-mind-control charisma (Glibness/Silver Tongue). Core duality: cold-geometry Sovereign ('Silver Butcher', unite-the-world-against-the-Long-Night agenda) vs the Girl craving the Ditchbond with Ser Duncan the Tall. House Peake destroyed the Baelarys enclave and has been systematically ruined in revenge. Mechanics: L6 Baelarys Weaver (modified Swords Bard), INT 20/CHA 18/DEX 16, magic reflavored as Ancestral Resonance for low-magic Westeros. Status: incognito as squire 'Silver' on the Road to Ashford, 209 AC, helping Dunk win the tourney. Created 9 entity pages (Visenya, House Baelarys, Dunk, Maekar, Egg, Baelor, Aerion, Daeron, House Peake) and 6 concept pages (ApexBloodline, MortalMask, SilverTongue, SovereignGirlDuality, Ditchbond, AncestralResonance). Flagged v4-vs-V6 version-lineage inconsistency and mid-sentence source truncation.

## [2026-08-04] ingest | The Apex of Ash: The Sowing — campaign visenya v3

Key claims: New Dance of the Dragons campaign bible (Dragonstone, 129 AC) explicitly refactored to a Charisma-18 Sorcerer build. PC Visenya "Silver" Belaerys, last of the Valyrian Apex line, poses as a Dragonseed to claim Vermithor during the Sowing while serving as Rhaenyra's hidden weapon. Homebrew Dragon Lord (Apex Bloodline) subclass: Subtle Apotheosis (free zero-cost Subtle Spell on mind/dragon magic, read as "divine luck"), Noblest Dialect (Advantage on CHA in High Valyrian vs Valyrian descendants/dragons), and a 0-100 Ascension Meter threat gauge (high → Architects of Silence mage-hunters + Rhaenyra's paranoia; low → powerless peasant death). Anchor NPC Gerrick the Smith provides the mortal-tie protection pact. Opening scene: three-path claiming of Vermithor (subtle Calm Emotions / "Lykirī" Apex Command at +15 meter / Jaehaerys voice illusion). Created 6 entity pages (VisenyaBelaerys, RhaenyraTargaryen, Vermithor, GerrickTheSmith, ArchitectsOfSilence, Dragonstone) and 5 concept pages (DragonLordSubclass, AscensionMeter, SubtleApotheosis, NoblestDialect, TheSowing). Cross-links: same-day saita v3 AethelgardEmpire apex-bloodline parallel, Sariel ValyrianFreehold setting kinship, and the recurring masked-power/threat-gauge mechanic family (Mask of Fragility, BurdenOfSupremacy).

## [2026-08-04] ingest | The Apex of Ash: Shadow of the Mother (campaign visenya v2)

Key claims: New ASOIAF campaign bible — Visenya Belaerys (16, INTJ "Reluctant God-Queen"), last of House Belaerys whose Apotheosis ritual triggered the Doom in this canon, hides as a freedwoman beside Daenerys during the Astapor/Meereen campaign. Mechanics: Belaerys Allure (DC 18 WIS-save charm on sight, +5 tracking cost per use), Dragon Scholar wizard subclass with Subtle Apotheosis (componentless invisible casting) and Royal Insight (INT/WIS social checks), L1–30 arc ending in reality re-weave 1/day. Created entities VisenyaBelaerys, HouseBelaerys, DaenerysTargaryen, JorahMormont; concepts BelaerysAllure, SubtleApotheosis, DragonScholarClass, FunctionalObscurity. Third 2026-08 hidden-apex-bloodline bible (with Saita and Sariel); Doom-attribution divergence vs Sariel canon flagged; Apotheosis name collision with ProjectApotheosis disambiguated.

## [2026-08-04] ingest | Blades of the High and Low — Valeria Vex spellblade campaign

Key claims: New campaign bible (campaign veleria iseki reborn). PC Valeria Vex, 15yo border-baron daughter and Royal Knight Academy squire, L6 Fighter/Bladesinger spellblade gestalt, secretly the reincarnation of the Warrior Queen who unified the kingdoms 1000 years ago and whose research became the Highlanders' floating plateau-cities. She rejects rulership — power fantasy is mastery/freedom, not governance. Aether (fluid/luminous/adaptive primordial energy) bypasses Highlander bloodline caster restrictions. Core mechanic: witnessed reveal loop with per-witness knowledge tracking, explicitly forbidding a global suspicion meter. No mindless monsters — all threats are people. GM instructed never to nerf the gestalt; challenge via preparation/terrain/objectives, never inflated numbers. Created 4 entities (ValeriaVex, WarriorQueen, Highlanders, RoyalKnightAcademy) + 4 concepts (AetherPrimordialEnergy, SpellbladeGestalt, WitnessedRevealMechanic, HighlanderLowlanderDivide). Source truncated mid-'Stance' section; filename 'veleria/iseki' vs content 'Valeria'/reincarnation noted as contradictions.

## [2026-08-04] ingest | The Hollow Zenith: Princess Saita Aethelgard's herald bluff in post-Absolute Baldur's Gate — campaign saita v3

Key claims: New 'saita' campaign line. Aethelgard Empire = eugenics apex-predator civilization (Emperor Tiberius L20, nobles L12 by 40) secretly ruined by Cadet Branch civil war; expands into post-Absolute Baldur's Gate. PC = Princess Saita Aethelgard (L1) undercover as 'Herald Saita Kross', Lawful Evil 'Patient Apex' INTJ/ENTJ archetype with public-diplomat/private-supremacist dual masks. Core mechanic: Imperial Bluff (Cha-based backdown grants Temp HP = Cha mod + Level; exposure of identity/imperial weakness inflicts Exhaustion). Named NPCs: Duke Ravengard, Kaelen (retainer), Flaming Fist, Patriars. Created entities: SaitaAethelgard, AethelgardEmpire, TiberiusAethelgard, KaelenAethelgard, UlderRavengard. Created concepts: ImperialBluff, WeaknessMaskingDiplomacy, PatientApexArchetype, BurdenOfSupremacy. Noted filename-v3 vs internal-v0 version discrepancy.

## [2026-08-04] ingest | The Embers of Valyria — Sariel Ash and the vanguard exodus from the Valyrian Freehold

Key claims: New ASOIAF-prequel campaign bible at the Valyrian Freehold's zenith, hours before a 20-v-20 Forty Families civil war. Protagonist Sariel Ash (L6, INTJ, Lawful Neutral) is a Great Bastard serving House Vaelaros as the 'Dread-Wyrm Shadow' gestalt assassin; goal is a vanguard exodus leading the mocked 41st House (Targaryen) to Westeros by exploiting the Freehold's institutional blindness. Mechanics: beauty as a literal destabilization tool (continues [[BeautyAsWeapon]]), dragon companion scaling with character level to 2× Balerion. Created entities SarielAsh, HouseVaelaros, HouseTargaryen, ValyrianFreehold, DaenysBelaerys; concepts DreadWyrmShadow, FortyFamiliesCivilWar, LevelScaledDragonCompanion, VanguardExodus. Source doc truncated mid-Section 2.

## [2026-08-04] ingest | Campaign summary prompt — multi-model design review (ChatGPT, AI Studio Gemini, Cursor Gemini)

Key claims: (1) Draft prompt casts the AI as a GM's assistant producing strict chronological bullet summaries of canonical events and state changes from raw campaign transcripts. (2) All three reviewers independently flagged the fuzzy 'significance' criterion; Cursor Gemini's fallback is err-toward-inclusion. (3) ChatGPT added: chronology handling for timestamp-less transcripts, per-session retcon formatting ('DM Note Retcon (Session 3): ...'), chunking for long transcripts, optional per-bullet sequence metadata. (4) AI Studio Gemini contributed the Itachi Level 20 compression example and the think-block CHOICE_ID resolution rule. (5) Cursor Gemini's verdict: ready as-is; add place-at-revelation ordering for off-screen events. New concepts: CampaignSummaryPrompt, SignificanceThreshold, RetconDMNote, OffScreenEventRevelation, TranscriptChunkingSummarization, ThinkBlockChoiceResolution. New entities: ChatGPT, GoogleAIStudio, Cursor, ItachiUchiha.

## [2026-08-04] ingest | Campaign Bible Prompt Template v4

Key claims: Ingested the generator meta-prompt (v4) behind the solo D&D 5e campaign-bible family — not a campaign, but the production template. Part 1 defines three mandatory sub-templates: six-tier Standard Character Architecture (MBTI, trauma-rooted fear, persona vs. repressed interior, 2–4 unconscious beliefs), five-part Faction Structural Profile ending in an exploit Hook, and a 5e Relic Framework requiring passive boon + active feature with DC math + behavioral-urge drawback. Execution rule: never truncate; halt at section boundaries and ask to continue. Source truncates mid Part 2 Section 1 (Campaign Intro / The Hook). New entity: CampaignBibleTemplateV4. New concepts: StandardCharacterArchitecture, FactionStructuralProfile, TacticalMasterworkRelicFramework, MetaPromptCampaignGeneration. Interpretation (labeled): this template is the probable upstream generator for the Nocturne campaign bibles ingested 2026-08-04.

## [2026-08-04] ingest | Nocturne Old Republic — 'The House of the Dragon' campaign bible

Key claims: SWTOR AU setup doc for the Nocturne Old Republic line. Vitiate evolved the Empire via Project Apotheosis (eugenics/Force-breeding) producing the Golden Lineage — publicly Imperial Princes/Princesses, privately replacements for the Dark Council. Family roster: Vitiate (Patriarch, Citadel of Storms, plans The Harvest), Senya (retconned to ex-Imperial Guard Commander, High Justice of the Sphere of Justice), Arcann (High Marshal, Obsidian Armada, maimed at Sacking of Coruscant), Thexan (Grand Vizier), plus new siblings Valtoria (Alchemist, Genetic Vaults/Sithspawn) and Draven (Beastmaster, pet Terentatek 'Glory'). Three-faction shadow civil war: Council of Twelve (Darth Marr/Baras traditionalists), Obsidian Circle (Arcann's neo-imperialists), The Eclipsed (Prophetess-led nihilists who know about The Harvest; doc truncated mid-section). Merged with the played 1644-entry campaign's endgame pages as start-vs-endgame states. Updated 6 entities (Vitiate, Senya, Arcann, Thexan, HouseVitiate, +ProjectApotheosis concept), created 5 entities (Valtoria, Draven, DarthMarr, DarthBaras, TheProphetess) and 5 concepts (GoldenLineage, TheHarvest, CouncilOfTwelve, ObsidianCircle, TheEclipsed).

## [2026-08-04] ingest | The Deceiver's Crown: Nocturne Ravencrest and the Pale Kingdom (Warcraft 3 v1.0.0)

Key claims: New Warcraft III × D&D 5e alternate-timeline Third War campaign line for the recurring Nocturne persona (Warcraft instantiation: NocturneRavencrest, 16, Stormwind paladin / Captain-Commander). Fully sentient Scourge worldbuilding (Cult of the Damned as mercenary priesthood, Lich King as coalition tyrant). Mal'Ganis survives Northrend and binds to Nocturne via a Dual-Custody Pact with a mutual-destruction clause — partner, not patron. Core design pillar: Sovereign Decoupling Principle (intrinsic combat power never coupled to reputation; per-NPC witness persistence instead of global suspicion meters, explicitly answering pitfall P24). Gameplay is dual-stack (public paragon / shadow intelligence service); endgame is the Pale Crown sovereign living-undead nation. Created 9 entity pages (NocturneRavencrest, MalGanis, SylvanThePale, MarcusRavencrest, CultOfTheDamned, LichKing, ArthasMenethil, HousePrestor, FourthStormwindExpeditionaryDetachment) and 5 concept pages (SovereignDecouplingPrinciple, DualStackGameplay, DualCustodyPact, SentientScourge, PaleCrown). Unlike BG3 v3/v5 (ruin/de-power openings), this line starts at the top and stays there.

## [2026-08-04] ingest | Nocturne Sosuke campaign v7 — The Velvet Cage (Descent Edition) revision

Key claims: v7 revises the v5 Descent Edition with a dual Fallen Siren/Ascendant character profile ('Vessel of Stolen Fire') and a formalized six-stage Level 0–20 physical evolution table (Ruin → Porcelain Doll → Uncanny Valley → Predator → Sovereign → Ascended) whose theme is perfection-not-monstrosity; each stage carries an NPC social-read escalation, making appearance a leveled information channel. New concept: UncannyValleyProgression. Entity updated: NocturneSosuke (Descent Edition section, age discrepancy noted: 16 here vs 18 in v4). Archival policy from the v5 ingest applied: mechanical/plot summary only; sexualized physical descriptions of the 16-year-old protagonist not reproduced. Contradictions logged: age across lines, internal dual-profile precedence, embedded play-state attire note.

## [2026-08-04] ingest | Nocturne Tyranny — The Architecture of Ascension

Key claims: First non-BG3 branch of the Nocturne campaign line — moves the protagonist into Obsidian's Tyranny setting (Terratus, The Tiers, Year 431 TR) as a Fatebinder. Bard (College of Swords) mechanically, roleplayed as Order of Scribes Wizard ('reality refactoring' — proofs that force reality to self-correct). Lawful Evil 'Systematizer' with self-authored Code held above Kyros' law. Core social mechanic: Courtly Shadow mask running dependency-loop manipulation (front-loaded value → indispensability → control) plus Johan Liebert-style desire-mirroring, targeted at Graven Ashe and the Voices of Nerat. Archetype stack: Griffith + Aizen + Johan, framed as the 'Wounded Architect' (fears insignificance over failure). Source truncated mid-section-II. New entities: TyrannyGame, Terratus, Kyros, GravenAshe, VoicesOfNerat, Disfavored, ScarletChorus, JohanLiebert. New concepts: CourtlyShadowMask, DependencyLoopManipulation, RealityRefactoring, WoundedArchitectArchetype.

## [2026-08-04] ingest | Nocturne BG3 v4 — 'The Velvet Cage' (2026-08-04 revision)

Key claims: Level 1 brothel-noir revenge start in BG3 Act 3 Baldur's Gate; Nocturne Sosuke (18, Bard, Siren's Leverage +2) discovers her sisters were minted into Soul Coins by the Cassalanters and infiltrates the Ascension Gala; climax is the InversionRitual skill challenge (steal Zariel's pact beneficiary, 4-before-3, Persuasion DC 16 with coin as +5 down payment); addendum revises College of Perdition into College of Infernal Contracts (Black Ledger signatories as damage sinks/spell fuel, level+CHA active cap); BG3 origins recruited as contracted Assets with per-companion attraction flags and leverage. New entities: MadamZylra, Grum, Vespera. New concepts: CollegeOfInfernalContracts, InversionRitual, CompanionContractRecruitment. Updated: NocturneSosuke, CassalanterFamily, HorgusGwent, BloomShadow, CollegeOfPerdition, SirensLeverage. Contradiction logged: Perdition vs Infernal Contracts naming (doc precedence rule resolves); Thay-v1 ancestral framing vs present-day playable origin (CrossPlatformAscensionPattern).

## [2026-08-04] ingest | Nocturne BG3 campaign v3 — From Ruin to Archdevil (College of Perdition origin)

Key claims: v3 of the NocturneSosuke BG3 line; 70–100 session arc, levels 1→20 + epic 25; House Sosuke ruined by Cassalanter debt manipulation during the 1492 DR Absolute crisis; prologue 'The Broken Cage' (Sessions 1–5) at The Bloom Shadow under Madam Zylra; Horgus Gwent intelligence-extraction scene reveals sisters held at Sunder-Stone Villa as soul-tithe collateral for Zariel; allies Vaximus/Kaelen/Vesper recruited; Sessions 4–5 heist climaxes in the SoulTitheInversion consuming the Cassalanter nobles. New pages: 6 entities (HorgusGwent, MadamZylra, Vaximus, TheBloomShadow, SunderStoneVilla, Zariel), 3 concepts (CollegeOfPerdition, SoulTitheInversion, VictimToPredatorTransformation). Contradictions logged: level-9 start vs level 1–3 prologue; Cassalanter Waterdeep/Asmodeus canon deviation; CR scaling issues.

## [2026-08-04] ingest | Nocturne Sosuke campaign v5 — The Velvet Cage (Descent Edition)

Key claims: v5 reboots the Nocturne line onto the BG3 nautiloid-crash opening. Level 6 Malcanthet-pact warlock de-powered to Level 1 via in-fiction tadpole suppression ([[TadpoleSuppressionNerf]]); campaign arc = break the dam, reclaim stolen infernal power. New mechanics: [[MalcanthetsFavor]] (death-save replacement, 1/long rest, levels 1-3) and [[PredatorPresenceIntimidation]] (whispered fear-based social dominance at STR 8). Entities: [[Malcanthet]], [[Zylra]], [[Zevlor]]. Archive note: source's sexualized descriptions of the 16-year-old protagonist were deliberately omitted; only mechanical/plot content recorded.

## [2026-08-04] ingest | Nocturne Sosuke campaign v6 — The Velvet Cage (Descent Edition)

Key claims: 6th iteration of the Nocturne BG3 campaign line; tone pivot to Survival Horror / Gothic Noir / Infernal Politics with explicit later-text-wins precedence rule. Protagonist Nocturne Sosuke ('The Black Diamond', 16, half-elf) defined as the Vessel of Stolen Fire: living-marble skin, violet-to-pink Abyssal eye-flood, at-will horns/retractable wings, Sovereign of the Shattered Rose. Core mechanic ingested: PorcelainPerfectionProgression — 7-stage Level 0–20 table (Ruin → Porcelain Doll → Uncanny Valley → Predator → Sovereign → Ascended) built on 'you do not grow monstrous; you grow perfect.' Named-but-undefined ability Pheromone Spike recorded as stub. Source truncates mid-Level-20; entity pages NocturneSosuke + ShatteredRose and concept pages PorcelainPerfectionProgression + PheromoneSpike created/updated.

## [2026-08-04] ingest | Sariel — Military Prosecutor Doberman campaign

Key claims: First modern K-drama-setting campaign (Military Prosecutor Doberman, Korean military-legal world) — prior campaigns were Rome/Faerûn/isekai. PC Sariel, 26, Bard College of Swords re-flavored, hides chaebol-grade beauty behind a bodyguard cover (BeautyAsWeapon inverted into camouflage). Personality = SerpentQueenArchetype, an explicit four-villain blend (Griffith/Tywin/Aizen/Johan Liebert) operating via the TwoMaskFortress (Silent Servant + Dispassionate Strategist). Drives: PortableAbsolutePower ("become the boardroom" — secular translation of the divine-ascension endgame) and SurgicalDomination (Bardic suggestion as frictionless control; targets Yong Moon-gu). Noh Tae-nam is charge/puppet-scaffolding; Do Bae-man is the designated adversary; IM Defense is the corporate probe target. Source text truncates mid-sentence in the Supremacist Certainty section. 9 entity pages + 4 concept pages created; no contradictions with existing pages.

## [2026-08-04] ingest | Gaia Julia campaign v5 — The Gilded Trap: Blood on the Marble

Key claims: v5 iteration of the Gaia Julia line, 73 BCE, Third Servile War as backdrop; inverted-hostage premise (rebels capture a hidden Level 12 Bard/Paladin Gestalt posing as Level 1 'Livia of Capua'); win condition is destroying rebel leadership from within via social engineering. New mechanics: The Muse (psychic damage for crude violence / d12 Inspiration for social wins), Velvet Iron (always-active Subtle Spell on Enchantment+Illusion), College of the Siren (voice-as-focus Bard subclass). New entities: Crixus, TheLotusTen, JuliusCaesar (cross-version page). Timeline/level/class variance across v2/v3/v5/v6 recorded as version-scoped, not contradictions. Source document truncates mid-Velvet-Iron section.

## [2026-08-04] ingest | Gaia Julia v4 — The Gilded Trap: Blood on the Marble

Key claims: v4 of the Gaia Julia line inverts the captivity trope — 73 BCE, Caesar already Dictator Perpetuo, Spartacus/Crixus rebels 'capture' 16-year-old Gaia Julia Caesar under the alias Livia of Capua, actually a Level 12 College of the Siren Bard/Paladin gestalt running social-engineering warfare from inside the rebel command tent. New mechanics: The Muse / Symphony of Ruin (psychic damage = level for crude violence; d12 Inspiration for social dominance) and The Velvet Iron (permanent Subtle Spell on Enchantment/Illusion, Voice as focus). New entities: Crixus, The Lotus Ten (gesture-commanded embedded slave network); updated GaiaJuliaCaesar cross-version entity. Contradictions logged: per-version timeline drift (82/73/71/44 BCE) and v3-Level-1 vs v4-Level-12 retcon-as-disguise. Source document truncates mid-Velvet-Iron description.

## [2026-08-04] ingest | Nocticula — Scion of the Abyssal Throne (hidden power)

Key claims: New campaign character bio — Nocticula, 16, half-demon granddaughter of a reigning Demon King, fugitive from demonic Retrieval Squads and human Purge Slayers. Explicit 'Frieren scale' hidden-power mechanics: ManaVeilMastery (reads as Level 1 to all detection), DemonicOvercasting (+2 effective spell tiers), SubtleWeaving (component-less casting), balanced solely by TheRevealConstraint (regional mana-spike alert on full-power use). Psychology is INTJ 'Clinical Pragmatism' / Optimal Outcome reasoning — the user's serpent-mastermind pattern in a True Neutral register rather than Lawful Evil. Created entities Nocticula + AbyssalDemonKing; concepts ManaVeilMastery, DemonicOvercasting, SubtleWeaving, TheRevealConstraint, OptimalOutcomeReasoning, and the cross-campaign HiddenPowerArchetype synthesis page linking NocturneSosuke/SosukeAizen and DivineDetectionTiers.

## [2026-08-04] ingest | Gaia Julia v3 — The Pax Caesara: The Daughter of the Phoenix

Key claims: Third protagonist-variant of the survived-Ides Julian god-dynasty frame — Gaia Julia Caesar (16, Lawful Evil 'Sadistic Voyeur'), youngest of five, incognito in Capua (44 BCE) building a gladiator 'toy army.' New entities: GaiaJuliaCaesar, JuliusCaesar, Calpurnia, Caesarion, Octavian, JuliaMajor, JuliaMinor, Capua. New concepts: Auctoritas (authority as literal force + CHA casting), ImperatorClass (custom Noble/Sorcerous prodigy class), BoredGodGaze (peace-as-decadence engine). Contradictions logged: incompatible sibling rosters and divergence dates vs Aurelius v1/v3 variants; Caesarion age ahistorical; sheet truncated mid-Actor-feat.

## [2026-08-04] ingest | Gaia Julia campaign v2 — 'The Golden Republic' (Pax Julia Alternate)

Key claims: Female-protagonist sibling of the Aurelius Julian-heir campaigns — Gaia Julia Caesar (16), Level 12 gestalt Imperator (Conquest Paladin × Divine Soul Sorcerer, CHA 22, AC 26, DC 21), infiltrates the House of Batiatus in 82 BCE under the fake-heiress alias 'Gaia of the Gens Vibia' to break Spartacus. New entities: GaiaJuliaCaesar, Batiatus, Lucretia. New concepts: GestaltImperatorClass, SingularitySolipsism, SocialArmorWardrobe, PaxJuliaTimeline. Contradictions recorded: 82 BCE vs 73/71 BCE Spartacus chronology across sibling campaigns; low-magic setting vs +3-loaded Level 12 start (lore-patched as First Founder artifacts).

## [2026-08-04] ingest | Gaia Julia Caesar campaign v6 — Iron Eagle: Vengeance + Decadent Conqueror bible

Key claims: v6 reuses the v3 Iron Eagle frame verbatim (71 BCE Third Servile War, Emperor Julius Caesar, Aurelius as Shadow Prince under the Aurelius Varenus merchant cover, L6 College of Swords Bard, Miasma, mandate to end the Spartacus revolt) and adds a new master personality sheet: the Decadent Conqueror (ESFP-ENTJ hinge), Blood of Venus (beauty-as-armor, Auctoritas as Heat), Prince of Pleasure vs Golden Tyrant dual masks, and the Sensory Feast appetite compulsion ("Devouring Maw"). Entities: AureliusJuliaCaesar (updated), JuliusCaesar, Glaber, Spartacus (updated). Concepts: DecadentConqueror, BloodOfVenus, SensoryFeast, ShadowPrince. Contradictions flagged: feminine "Gaia" title vs male character body; document truncated mid-sentence in section IV.

## [2026-08-04] ingest | Bumpkin Swordsman campaign — 'The Rust-Bound Blade' grounded geopolitical bible

Key claims: Post-BG3 Western Heartlands sandbox, martial-arts-noir / cold-war tone, Gestalt Tier-2/3 architecture. Level 12 is the absolute mortal ceiling (<50 active L12s continent-wide; 13–20 reserved for Chosen like Elminster, liches like Szass Tam). Master Vaelen is the anomaly: natural martial prodigy, ex-Thayan L20 Gestalt general, deserted from guilt 20 years ago; trauma locks output to L12 while his self-image reads as 'sluggish failure' (Perception Paradox). His dojo's 99% attrition produced exactly 20 graduates split into ideological networks (Good Circle = 10, publicly the Western Kingdom's martial elite). Source truncated mid-Section 2.1. New entities: MasterVaelen, Thay, SzassTam, Elminster. New concepts: Level12MortalCeiling, VaelenCalibrationCrisis, GestaltTierSystem, TwentyDisciplesMatrix.

## [2026-08-04] ingest | Aurelius Caesar v3 — 'The Iron Eagle: Vengeance' campaign bible

Key claims: v3 of the Aurelius Caesar campaign line. Divergent 71 BCE: Republic dead, Julius Caesar rules as Emperor; PC is his 16-year-old son Aurelius Caesar (cover: merchant 'Aurelius Varenus'), L6 College of Swords Bard wielding the Miasma (Divine Blood), sent to end the Spartacus revolt with 50K gold + black-ops Praetorians. New entities: AureliusCaesar, JuliusCaesar, Spartacus, Glaber, JulianDynasty. New concepts: ShadowPrinceArchetype, Miasma, BeautyAsWeapon, SensoryFeastCompulsion. Notable: ESFP-ENTJ 'Decadent Conqueror' inverts the household's usual INTJ fragile-mastermind pattern — beauty/warmth as the deception weapon instead of fragility. Source truncated mid-section IV ('The Sensory Feast'); later tabs not captured. Internal naming inconsistency ('Aurelius Julia Caesar') recorded.

## [2026-08-04] ingest | Aurelius v1 — The Iron Eagle: Pax Caesara

Key claims: Alternate-history Rome campaign bible (v1) — Julius Caesar survived the Ides; 40 BCE 'Perpetual Dictatorship' empire (Pax Caesara). PC Aurelius Julia Caesar, youngest son of the God-Emperor, explicitly Lawful Evil tyrant-in-training. New archetype: DecadentConqueror (ESFP-ENTJ hinge) — first major break from the corpus's INTJ serpent-mastermind norm. New mechanics/concepts: BeautyAsWeapon (Blood of Venus social armor), SensoryFeast (intensity-craving compulsion, ultimate target 'The World Soul'), FratricidalColdWar (sibling succession spine), TheMiasma (true-self sheet register). Entities: AureliusJuliaCaesar, JuliusCaesar (Pax Caesara timeline), PaxCaesaraEmpire. Source truncated mid-document.

## [2026-08-04] ingest | BG1 Nocturne campaign — 'The Serpent Queen' character profile

Key claims: The serpent-mastermind persona is ported to a Level 1 BG1 opening as a 16-year-old bard scribe in Candlekeep hiding jarring beauty under mundane grime. Explicit composite archetype (Griffith/Tywin/Aizen/Johan Liebert) recorded as [[SerpentQueenArchetype]]. Two-persona social architecture ([[TwoMasksArchitecture]]: Dutiful Ward data-probes + Dispassionate Strategist win-win scaffolding) is the core game loop. Drives: [[PortableAbsolutePower]] ("become the throne"), surgical domination via bardic Suggestion, supremacist certainty. Divinity route is inherited [[BhaalspawnEssence]] — third distinct ascension mechanism in the [[CrossPlatformAscensionPattern]] family (engineered, consumed, inherited). New entities: [[SerpentQueen]], [[Candlekeep]], [[Gorion]]. Source document truncates mid-sentence in the Supremacist Certainty section.

## [2026-08-04] ingest | Aurelius v2 — 'The Iron Eagle: Pax Caesara'

Key claims: Alt-history Rome, 40 BCE, Julius Caesar survived the Ides and rules as God-Emperor; player is Aurelius Julia Caesar, youngest son, 'Sun of Rome' with Devouring Maw true nature. Bible is authored Lawful Evil but v2 opens with the player directive 'make me lawful good' — captured as new concept AlignmentConversionRequest. New concepts: PaxCaesara, WeaponizedBeauty (links Aurelius to Alexiel's porcelain-doll framing and HaloEffect). New entities: AureliusJuliaCaesar, JuliusCaesar (timeline variant). Source truncates mid-sentence at the 'World Soul' objective.

## [2026-08-04] ingest | Aizen Thay v1 — The Black Company & The Sovereign's Hunger (Nocturne ancestor bible)

Key claims: Campaign bible restructures the Aizen/Nocturne mythos into an ancestor-patron sequel set +100 years post-Ascension (Century of Silence). Nocturne Sosuke recast as Aizen's great-grandmother: 1492 DR House Sosuke scion trafficked by the Cassalanters, seduced the illithid parasite, internalized the Crown of Karsus, dominated Zariel/Asmodeus/the Demon Lords, reached 'Level 60,' and was quarantined (not killed) by Ao's Geometric Firewall into the Shattered Rose sub-plane. Aizen is 'the Spare,' a custom Abyss Knight bound via the Obsidian Mirror pact as her sole Material Anchor. New concepts: GeometricFirewall, ShatteredRose, ObsidianMirrorPact, CenturyOfSilence, AbyssKnight, WeaponizedDesire. New entities: Zariel, Asmodeus, CassalanterFamily; updates to NocturneSosuke, SosukeAizen, Ao, house-sosuke. 5 contradictions logged, including the 'thay' filename mismatch and the great-grandmother timeline math.

## [2026-08-04] ingest | Alexiel SWTOR — 'The Siren' master character bible

Key claims: Level 1 Jedi Consular/Sith Sorcerer gestalt on the [[VoidExperimentClass]] chassis; 12-year-old engineered child of [[Vitiate]] held as political prisoner at a Jedi Academy; stats STR 8/DEX 14/CON 14/INT 16/WIS 10/CHA 18, HP 8, AC 12, 4 Force Points. Features: [[SirensCall]] (free Charm/Command with rationalized obedience), [[HaloEffect]] (WIS DC 14 hesitation defense), [[EssenceDevourer]] (temp-HP drain, 24h feed clock). Psychology: [[MaskOfTheInnocent]], [[TheStatic]] (Vitiate + [[Vaylin]] residue), [[TransactionalAffection]]. New entities: Alexiel, Vitiate, Vaylin, Atris, JaxPadawan; updated MasterOganDe. New concepts: EssenceDevourer, HaloEffect, TheStatic, TransactionalAffection, MaskOfTheInnocent. Note: source's inappropriate framing of the minor character was not reproduced; documented in neutral mechanical terms. Source truncated mid-sentence.

## [2026-08-04] ingest | World of Assiah campaign (Alexiel) — Century of Schism world guide Part 1

Key claims: Year-1509 setting; three-era timeline (Foundation 1–500 with Edict of Chains slavery building Aeterna; Abyssal War 500–1409 as the Creator's engineered culling crucible revealed to Lucifer in 1400; Century of Schism 1409–1509 civil war). Lucifer purged loyalists and marched on Aeterna in 1409, shattered the slave colonies in 1412 (March of Broken Chains). Campaign contract: exceptionally high persistence / very low drift — player (Alexiel, Western Marches) actions permanently ripple into Raziel's and Lucifer's continental strategies. Pillars: Weight of Immortality, Mathematics of Slaughter (50% Culling Doctrine), Mask and the Monster (performed cruelty hiding empathy — inverse of Mask-of-Fragility). New entities: Alexiel, Lucifer-Assiah, Raziel-Assiah, CelestialImperium, Aeterna, WorldOfAssiah. New concepts: CenturyOfSchism, AbyssalWar, EngineeredCrucibleWar, FiftyPercentCullingDoctrine, MaskAndMonster, EdictOfChains, EmpyreanAffliction, MarchOfBrokenChains, HighPersistenceWorldState. Source truncated mid-Part-1.

## [2026-08-04] ingest | Aizen teen campaign export — The Architect of Destiny

Key claims: Fresh prequel campaign starting Aizen at age 10, Level 1, as a House Sosuke scion in Baldur's Gate's Upper City. Signature house rule AgeProgressionByLevel (1 level = 1 year, capped at L10/age 20). Class left to player choice (Wizard Abjuration/Enchantment/Illusion, Bard Lore/Whispers, Rogue Thief/Mastermind); Sage background preferred; INT 15 standard array. Adult Aizen psychology ported in 'nascent' form: two developing masks (Polite Young Noble public face, Obsessed Learner private) over an unconscious perfectionist/cosmic-editor true self. Background factions: House Sosuke, Flaming Fist, The Guild, scholarly institutions. Explicit timeline reset: no God-King, Bane unconsumed, Cult of the Absolute distant/inactive. Contradicts the v2 Exiled Viper sheet on age at L4 (13 vs 16), class commitment, and noble-vs-orphan identity. Entities updated: SosukeAizen, house-sosuke, BaldursGate, FlamingFist, TheGuild. Concepts updated: AgeProgressionByLevel, PrequelOriginCampaign.

## [2026-08-04] ingest | BG3 'Empire of Shadow' aftermath campaign — Triumvirate dark-timeline world state

Key claims: Netherbrain dead but city not liberated; Astarion (Rite of Profane Ascension, Szarr Palace), Shadowheart (Sharran theocracy, House of Grief), and Gale (reforged Crown of Karsus, floating Ramazith citadel) rule as the Triumvirate of the Absolute's Bane. All other companions receive definitive tragic fates: Lae'zel astral guerrilla, Wyll trapped in Avernus, Karlach illithid sewer rebel, Minthara High General, Halsin shadow-beast, Jaheira raised as spawn, Minsc petrified, Withers withdrawn, Raphael reforming. New entities: TriumvirateOfTheAbsolutesBane, GaleOfWaterdeep, Laezel, Wyll, Karlach, Halsin, Jaheira, Minsc, Withers, Raphael. New concepts: DefinitiveCompanionFates, EmpireOfShadowAftermath. Noted continuity fork vs the Aizen campaign lineage.

## [2026-08-04] ingest | Aizen BG3 v2 — 'The Exiled Viper' level 4 character sheet

Key claims: Teen (16) Aizen mechanized as RAW-legal CHA-18 Half-Elf College of Swords Bard, Level 4, explicitly no magical power-ups — psychological predation + crime as the power base. Arcane Athenaeum detailed as blackmail factory (Whisperdust + Essence of Lethe spiked teas, study-group velvet trap); Challenge Compensation table calibrates post-BG3 threats (Lae'zel, Guild swarms, Zhentarim charm-immune devils, Lysandra visions, Isolde guilt-lever, Kaname pursuit). Contradiction logged: header says Wizard 'School of the Mirror Flower', body is Bard build. New entities: ArcaneAthenaeum, ElowenThorne, Lysandra, Isolde, Kaname, Zhentarim. New concepts: WhisperdustNarcotic, EssenceOfLethe, PowerlessMastermindBuild.

## [2026-08-04] ingest | BG3 aftermath campaign — Empire of Shadow: the dark Triumvirate rules the Sword Coast

Key claims: v0 premise doc for a post-Netherbrain evil epilogue of Baldur's Gate — Astarion (Ascended vampire), Shadowheart (Sharran Mother Superior), and Gale (Crown of Karsus pseudo-god) rule as the Triumvirate of the Absolute's Bane, splitting the Sword Coast into blood/shadow/arcana empires. Every other companion gets a fixed, mostly tragic fate (new concept: CompanionFateLedger). New entities: TriumvirateOfTheAbsolutesBane, Gale-of-Waterdeep, Laezel, Wyll, Karlach, Halsin, Jaheira, Minsc, Withers, Raphael, Shar. Distinct continuity from the Aizen god-campaign lineage; source is truncated mid-sentence at the Raphael entry.

## [2026-08-04] ingest | BG3 Voyage campaign — Nocturne Sosuke playtest: 107-turn soul-harvest run with platform feedback

Key claims: First wiki source for the Voyage platform. 107-turn post-BG3 campaign as NocturneSosuke (Sosuke lineage; patron Malacharet). Platform verdict: far better than AI Dungeon, but Worldsmith world builder needs a revamp (slow, low visibility); leveling/ability-point bugs recoverable via NarratorBugCorrection. Engine features: TieredSuccessOutcomes, DynamicSituationalModifiers, and ConsequenceEnforcement (ambient fiction state disrupts player commands). Four souls harvested (WyllRavengard, DrorRagzlin, PriestessGut, LarinnaDuskweaver) — confirms the consumption-ascension arc is a cross-platform player signature (CrossPlatformAscensionPattern), matching DivineAscensionByConsumption in the Aizen campaigns. New entities: Voyage, AIDungeon, Worldsmith, Malacharet, WyllRavengard, DrorRagzlin, PriestessGut, LarinnaDuskweaver. New concepts: ConsequenceEnforcement, CrossPlatformAscensionPattern.

## [2026-08-04] ingest | Aizen mortal campaign start — 'The Shadow over the Gate' clean-slate setup

Key claims: The mortal-era chat opens with a clean-slate restart of the 'bane - main' campaign — same characters/factions, reset state. Gemini frames 'The Shadow over the Gate' (D&D 5e, Baldur's Gate) with 5 factions: Flaming Fist (Ravengard), The Guild, Knights of the Shield, Cult of the Dead Three (Bane as subtle presence), and House Aizen as the rising hidden power. Opening 'A Night of Unrest' offers 4 convergent hooks (Elfsong brawl, dockside abduction, noble's plea, Fist patrol) unified by the 'unusual efficiency' signature of Aizen's hidden hand. New entities: KnightsOfTheShield, CultOfTheDeadThree, UlderRavengard. Concepts updated: ShadowOverTheGate, ANightOfUnrest, CleanSlateCampaignRestart, SubtleInfluenceCampaignHook, NarrativeHookScenarios.

## [2026-08-04] ingest | Aizen teen campaign export — 'The Architect of Destiny' prequel

Key claims: Fresh origin campaign for the Aizen lineage — age-10 Aizen at Level 1 in House Sosuke, Baldur's Gate. World state explicitly rewound (no ascension, Bane unconsumed, Cult of the Absolute dormant), making it a PrequelOriginCampaign specialization of CleanStateCampaignReset. Distinctive mechanic: AgeProgressionByLevel (1 year per level to L10/age 20). Adult mask system appears as nascent 'developing masks' (Inquisitive Young Noble + Obsessed Learner) over a raw true self — childhood antecedent of Mask-of-Fragility. Factions parked as background: House Sosuke, Flaming Fist, The Guild, scholarly institutions. Entities updated: house-sosuke, Bane, CultOfTheAbsolute. Concepts: PrequelOriginCampaign, AgeProgressionByLevel.

## [2026-08-04] ingest | Aizen god campaign — campaign genesis: The Shadow over the Gate setup and four starting hooks

Key claims: The Aizen god campaign's fresh start used a CleanStateCampaignReset (same cast/factions from "bane - main", clean world state) with Gemini 2.5 Flash ULTRA as DM; campaign titled *The Shadow over the Gate* in Baldur's Gate with five reimagined factions including new HouseAizen; opening "A Night of Unrest" offers four NarrativeHookScenarios (Elfsong brawl, dockside abduction, noble's plea, Fist patrol) all secretly signed by Aizen's hidden hand (SubtleInfluenceCampaignHook); chat index confirms arc structure mortal → v1m → v2m → v3m → godhood. New entities: KnightsOfTheShield, CultOfTheDeadThree, HouseAizen, UlderRavengard. New/updated concepts: ShadowOverTheGate, ANightOfUnrest, NarrativeHookScenarios, SubtleInfluenceCampaignHook, CleanStateCampaignReset.

## [2026-08-04] ingest | Aizen God Campaign — Mortal-Era Chat: ChatGPT-to-Gemini DM Handoff via Master Prompt

Key claims: The mortal-era chat contains no in-fiction play — it is the meta-conversation where Gemini prescribes the MasterPromptCampaignHandoff technique for migrating the ongoing Aizen campaign from ChatGPT. Method: curated state snapshot (campaign overview, PC sheets, recap/resume point, world state, quests, inventory) over raw transcript, assembled into one master prompt with explicit role assignment and resume directive. Gemini's worked example (Kaelen/Bror/Seraphina, "The Whispering Shadow") is placeholder template content, not campaign canon. This handoff is the origin of the CampaignContextMigration pattern later executed between Gemini chats 1 and 2; the two variants weigh the transcript differently (summary-only cross-platform vs full-log intra-platform). New/updated pages: entities ChatGPT, Gemini, AizenSosuke; concepts MasterPromptCampaignHandoff, LLMDMPlatformMigration.

## [2026-08-04] ingest | Aizen God Campaign — Chat 2: God-King of Absolute Codification

Key claims: player performed a [[CampaignContextMigration]] into a fresh Gemini chat with a definitive campaign export as a player-authored save file; Aizen ascended at L12 (Paladin 2/Bard 10) via [[DivineAscensionByConsumption]] of [[Bane]] to Nascent Greater Deity, targeting [[TranscendentGreaterDeity]] within one year; [[DivineImposition]] sets Divine Save DC 100 with no protagonist rolls, formally abolishing dice for social/knowledge play; [[KyokaSuigetsu]] persists into the divine frame; Charisma pre-boost to effective 35 signals a planned [[Elminster]]/[[Mystra]] negotiation. New entities: Bane, Elminster, KnightsOfTheShield. New concepts: KyokaSuigetsu, TranscendentGreaterDeity.

## [2026-08-04] ingest | Aizen god campaign chat 1 (entries 901-1147) — avatar autonomy protocol and telepathic Banite conversion

Key claims: Final segment of chat 1. Avatar granted Level 20 intellect with two-tier reporting (conferral only for major decisions + daily status) — codified as Divine-Avatar-Autonomy-Protocol. Mass telepathic conversion of former Bane followers ruled permissible: Divine Save DC 100, 50 DPP per wave, detection risk tiered across Mystra (minds), Shar (domain conflict), Ao (broad disruption). New concept pages: DivineDetectionTiers, TelepathicBaniteConversion; new entity pages: Bane, Shar. Segment truncated mid-sentence at export boundary.

## [2026-08-04] ingest | Aizen God Campaign — Chat 1, Entries 601-900: Knights of the Shield confrontation

Key claims: Aizen (L12, CHA 23) bypasses Knights of the Shield manor wards with Knock and preemptively seizes the interrogation frame. Delivers a manufactured truth narrative: parents Corvan + Seraphina Sosuke attempted the GrandConjunction to manifest Bane, Bane betrayed them, Corvan died, Seraphina fled with a counter-ritual; Aizen and brother Malachi purged cultist hubs. Frames Bane as an attack on the Knights' "balance" mission, recruiting the rival intelligence faction as unwitting allies. New entities: KnightsOfTheShield, Bane, CorvanSosuke, SeraphinaSosuke, MalachiSosuke. New concepts: UnwittingAllyRecruitment, PreemptiveFrameControl.

## [2026-08-04] ingest | Aizen god campaign chat 1 — campaign genesis: The Shadow over the Gate setup and faction web

Key claims: Player requested CleanStateCampaignReset of the "bane - main" chat; Gemini DM proposed campaign *The Shadow over the Gate* (D&D 5e, Baldur's Gate) with a 5-faction web — FlamingFist (under new entity UlderRavengard), TheGuild, KnightsOfTheShield (later principal counter-intel antagonist), CultOfTheDeadThree (Bane flagged as subtle presence, continuous with Child-of-Bane heritage), and HouseAizen (player power base). Opening state "A Night of Unrest" offers four NarrativeHookScenarios all converging on Aizen's hidden influence (UnusualEfficiencySignature). New entities: UlderRavengard, KnightsOfTheShield, CultOfTheDeadThree, Bane, HouseAizen. New concept: ANightOfUnrest (saturated multi-hook opening as convergent funnel). Contradictions logged: AizenSosuke/SosukeAizen entity duplication; HouseAizen vs house-sosuke naming drift.

## [2026-08-04] ingest | Aizen Sosuke campaign summary — mortal paladin to The Absolute via serial deicide

Key claims: spine summary of the Aizen god-campaign. Act 1: L8 Paladin/Bard heir of House Sosuke exposes the Cult of the Dead Three, kills his father (Bane's champion), breaks his mother into fealty, then consumes Bane's Tyranny portfolio and Myrkul's Death portfolio (Divine-Portfolio-Consumption) to reach Greater Deity. Act 2: subsumes Ao the Overgod via metaphysical debate (Conceptual-Debate-Victory), becomes The Absolute, and launches The Grand Game — elevating Gale of Waterdeep as puppet God of Magic and scripting a manufactured narrative that Gale consumed Mystra (ManufacturedTruthNarrative). Source truncates at Gale's second broadcast. Updated 8 entity pages (AizenSosuke, house-sosuke, CultOfTheDeadThree, Bane, Myrkul, Ao-the-Overgod, GaleOfWaterdeep, Mystra) and 4 concept pages (Divine-Portfolio-Consumption, Conceptual-Debate-Victory, The-Grand-Game, ManufacturedTruthNarrative). Flagged entity-name fragmentation across the Aizen lineage for consolidation.

## [2026-08-04] ingest | Aizen BG3 Campaign v2 — The Exiled Viper

Key claims: v2 restart of the AizenSosuke BG3 lineage pointed opposite the godhood arc — a 16-year-old Level 4 College of Swords Bard (CHA 18, Deception/Persuasion expertise) infiltrating the ArcaneAthenaeum as a meek scribe while running it as an AcademyBlackmailFactory (Whisperdust narcotic + Suggestion-enforced debts + "the Garden"). Profile engineers explicit ChallengeCompensation (social/physical/intrigue counters + XP/loot ladder, narrative failure states instead of TPK) to keep a L4 PC viable against post-BG3 L12/CR 5-10 threats. BG3 cast integrated (Gale as friendly INT foil; Wyll/Lae'zel/Zhentarim as counters). Contradiction logged: header says Wizard "Mirror Flower", stat block is RAW Bard. Third power-tier of the same serpent-mastermind persona: godhood → lich sovereignty → street-level mortal predation. New/updated pages: entities ArcaneAthenaeum, ElowenThorne, GaleOfWaterdeep; concepts AcademyBlackmailFactory, ChallengeCompensation, CollegeOfSwordsShadowBuild.

## [2026-08-04] ingest | Aizen God Campaign — Chat 1, Entries 1-300: The Shadow over the Gate opening

Key claims: Fresh D&D 5e clean-slate restart in Baldur's Gate with Gemini as DM; five reimagined factions (Flaming Fist/Ravengard, Guild, Knights of the Shield, Cult of the Dead Three with Bane carry-over, House Aizen); four intertwined opening hooks under "A Night of Unrest"; unifying tell is antagonists' unnatural efficiency + eye-like symbol — Aizen's hand visible only as a pattern of competence. New entities: UlderRavengard, KnightsOfTheShield, CultOfTheDeadThree, HouseAizen. New concepts: UnusualEfficiencySignature, FactionWebRestart. Flagged: TheGuild vs TheGuildBaldursGate naming, 4-way Aizen entity duplication, CleanSlate vs CleanState restart-concept duplication.

## [2026-08-04] ingest | Aizen god campaign chat 1 (entries 301-600) — Level 10 ascension and Destiny Rulebook stats

Key claims: Aizen advanced Level 9→10 (Paladin 2/Bard 8, 56,660→64,000 XP) via a player-directed grant of exactly 7,340 XP — canonical PlayerDirectedExpGrant instance. The 'add itg' shorthand was misread by the DM as an 'Infernal Taint' class-bonus request (Whispers-of-the-Realm-style elaboration of ambiguous input). Second ASI → CHA 23 (+6); Locate Creature learned. Sheet documents DestinyRulebookOverrides defensive stats (Effective Defense 20, Dodge 7, Armor Rating 20, Armor Mitigation 10) alongside standard AC 18. HP 59 asserted without recalculation at level-up → new concept DMBookkeepingTrustGap. New entity page: Bane (Child-of-Bane heritage + consumption arc); AizenSosuke entity updated with L10 build state.

## [2026-08-04] ingest | BG3 Voyage campaign — Nocturne Sosuke 107-turn run

Key claims: First source documenting the Voyage platform (voyage.io) — player rates it "night and day" better than AI Dungeon; leveling/ability-point bugs recoverable via narrator ([[NarratorBugCorrection]]); Worldsmith world builder (PR preview pr-9837) flagged as needing a huge revamp for speed + visibility. Engine uses [[TieredSuccessOutcomes]] + named [[DynamicSituationalModifiers]] on a modified 5e/BG3 chassis with epic scaling (CHA +24, Persuasion +25) and enforces environmental consequences (friendly fire from ink cloud, psychic static garbling commands). Campaign content repeats the Sosuke consumption-ascension pattern: [[NocturneSosuke]] (patron [[Malacharet]]) harvests souls of Wyll Ravengard, Dror Ragzlin, Priestess Gut, Larinna Duskweaver ([[SoulEssenceHarvesting]], sibling of [[DivineAscensionByConsumption]]). New entities: NocturneSosuke, Voyage, Worldsmith, WyllRavengard, DrorRagzlin, PriestessGut, LarinnaDuskweaver, Malacharet, Shadowheart, Minthara.

## [2026-08-04] ingest | Aizen teen campaign export — The Architect of Destiny

Key claims: Prequel origin campaign for the Aizen lineage — fresh campaign, Aizen age 10 at Level 1 inside House Sosuke (Baldur's Gate Upper City). Distinctive house rule: age progression by level (1 year/level to L10 = age 20, then normal timeline). Adult mask system restated as nascent 'developing masks' (Inquisitive Young Noble / Obsessed Learner) over an unconscious true self. World-state explicitly rewound: no God-King ascension, Bane unconsumed, Cult of the Absolute dormant. New concepts: AgeProgressionByLevel, PrequelOriginCampaign; new entities: CultOfTheAbsolute, house-sosuke (canonicalized). Flagged naming drift: house-sosuke vs HouseAizen, four Aizen entity page variants.

## [2026-08-04] ingest | Aizen BG3 Campaign v2 — The Exiled Viper

Key claims: v2 restart of the Aizen Baldur's Gate lineage at the opposite power tier — 16-year-old Level 4 Half-Elf College of Swords Bard (CHA 18, DC 15, Expertise Deception/Persuasion) with explicit 'no magical power-ups' constraint. Runs the Arcane Athenaeum as a blackmail factory (Essence of Lethe + 'Whisperdust' narcotic + Suggestion debts) exploiting post-Absolute faculty shortages. Introduces Challenge Compensation doctrine: counter the build's blind spots (high-Wis foes, swarms, scrying rivals, guilt levers) instead of inflating CR, with an explicit XP/reward ladder and narrative failure states. BG3 cast integrated (Gale friendly, Wyll antagonist, Lae'zel interrogator). New entities: ArcaneAthenaeum, ElowenThorne (stub — source truncated), LysandraRival. New concepts: AcademyBlackmailFactory, ChallengeCompensation, CollegeOfSwordsShadowBuild. Contradiction logged: header says Wizard 'Mirror Flower', stat block is Bard.

## [2026-08-04] ingest | BG3 aftermath campaign — Empire of Shadow

Key claims: Post-Netherbrain dark timeline where Astarion (Ascended), Shadowheart (Sharran Mother Superior), and Gale (Crown of Karsus pseudo-god) rule the Sword Coast as the Triumvirate of the Absolute's Bane. All companions receive definitive tragic fates: Lae'zel astral guerrilla, Wyll trapped in Avernus, Karlach illithid in the sewers, Minthara enforcer, Halsin feral, Jaheira spawn-raised, Minsc petrified, Withers withdrawn, Raphael reforming in the Hells. New entities: Astarion, Shadowheart, Laezel, Wyll, Karlach, Minthara, Halsin, Jaheira, Minsc, Withers, Raphael. New concepts: TriumvirateOfTheAbsolutesBane, PostVictoryDarkTimeline, RiteOfProfaneAscension, CrownOfKarsus. Flagged continuity split vs. same-day Aizen god-campaign ingests (two incompatible Baldur's Gate world states). Source v0, truncated mid-sentence.

## [2026-08-04] ingest | Aizen god campaign genesis — Shadow over the Gate setup

Key claims: New D&D 5e campaign 'The Shadow over the Gate' in Baldur's Gate via CleanStateCampaignReset from 'bane - main' chat; five factions (Flaming Fist under Ulder Ravengard, The Guild, Knights of the Shield, Cult of the Dead Three with Bane as subtle presence, new House Aizen); four 'Night of Unrest' starting hooks (Elfsong Tavern brawl, dockside abduction with eye symbol, noble's plea, Flaming Fist patrol) all bearing Aizen's unusual-efficiency signature (SubtleInfluenceCampaignHook). Chat index reveals arc structure mortal→v1m→v2m→v3m→godhood. Contradiction noted: House Aizen vs House Sosuke naming across sources.

## [2026-08-04] ingest | Aizen God Campaign — Chat 2: God-King of Absolute Codification campaign export and continuation

Key claims: Player migrated the Aizen campaign to a fresh Gemini chat via a four-artifact context handoff (campaign info, full chat log, style-only ASOIAF reference files, original prompts). Definitive export establishes Aizen as Nascent Greater Deity (God-King of Absolute Codification, Tyranny, Control) after consuming Bane's essence at Level 12 (Paladin 2 / Bard 10, 113,440 XP). Custom divine layer: DR 750/750, DAC 25, DPP 715/825 daily, PB +6 transcendental, divine CHA 30 (temp 35 for planned Elminster/Mystra negotiation), Divine Save DC 100 with no-roll Divine Imposition and auto-success ability checks. Kyōka Suigetsu active across the ascension boundary. Goal: Transcendent Greater Deity within one year. New entities: Elminster, Mystra. New concepts: DivineImposition, DivineAscensionByConsumption, CampaignContextMigration. Contradictions logged on CHA (23 mortal vs 30 divine), XP jump, and PB override.

## [2026-08-04] ingest | Aizen god campaign — mortal-era chat opening: ChatGPT-to-Gemini DM handoff via master prompt

Key claims: The mortal chat opens with meta-conversation, not fiction — the player asks Gemini how to migrate the running campaign off ChatGPT. Gemini prescribes the MasterPromptCampaignHandoff: a six-part state snapshot (campaign summary, PC sheets, previously-on recap, world state/NPCs, active quests, inventory) assembled into one fill-in template with role assignment + resume directive. Design insights: summary over transcript, state not story, explicit resume point. Worked-example entities (Kaelen, Bror, Seraphina, Cult of the Whispering Shadow) are placeholder template content, not Aizen canon. New entities: ChatGPT, Gemini. New concepts: MasterPromptCampaignHandoff, LLMDMPlatformMigration. Complements CleanSlateCampaignRestart (state-preserving vs state-resetting continuity).

## [2026-08-04] ingest | Aizen god campaign chat 1 — campaign genesis

Key claims: Player requested a clean-state reset of the "bane - main" cast into a new Baldur's Gate campaign; Gemini DM proposed "The Shadow over the Gate" (D&D 5e, intrigue themes) with five factions — Flaming Fist under Ulder Ravengard, The Guild, Knights of the Shield, Cult of the Dead Three (Bane as subtle presence), and rising wildcard House Aizen — plus four intertwining PC starting hooks unified by the signature of Aizen's hidden influence. New entities: HouseAizen, FlamingFist, UlderRavengard, TheGuild, CultOfTheDeadThree, ElfsongTavern. New concepts: ShadowOverTheGate, CleanStateCampaignReset, NarrativeHookScenarios.

## [2026-08-04] ingest | Aizen god campaign chat 1 (entries 901-1147) — avatar autonomy protocol and telepathic Banite conversion

Key claims: Final chat-1 segment covers post-ascension governance. (1) Avatar autonomy protocol: Level 20 avatar acts independently, escalates only 'important decisions' (major conflicts, deposing rulers, artifacts, Flaming Fist/Knights of the Shield confrontations) and reports daily unprompted. (2) Telepathic conversion of Bane's former cultists ruled legal under Domain Influence: Divine Save DC 100 makes it unresistable; costs 50 DPP per wave as Major Domain Manipulation; risks detection by Mystra (minds), Shar (domain conflict), Ao (broad disruption); puppets must not act 'too perfectly.' Segment truncates mid-sentence as player proposes an alternative strategy. New entities: Mystra, Shar, Ao, Flaming Fist. New concepts: Divine-Avatar-Autonomy-Protocol, Divine-Power-Points, Telepathic-Domain-Usurpation.

## [2026-08-04] ingest | Aizen Sosuke campaign summary — mortal paladin to The Absolute via serial deicide

Key claims: Aizen Sosuke (L8 Paladin/Bard, House Sosuke of Baldur's Gate) uncovers his parents Lord Volcain and Lady Seraphina as leaders of the Cult of the Dead Three; commits patricide and subjugates his mother. Consumes Bane's Tyranny portfolio (first deicide, apotheosis), then Myrkul's Death portfolio (Greater Deity). Subsumes Ao the Overgod through a metaphysical debate — a Conceptual Debate Victory — becoming The Absolute. Elevates Gale of Waterdeep to God of Magic and scripts his broadcast claiming Mystra's consumption, launching The Grand Game. Source truncates mid-broadcast. New entities: Aizen-Sosuke, House-Sosuke, Cult-of-the-Dead-Three, Gale-of-Waterdeep, Ao-the-Overgod, Bane, Myrkul. New concepts: Divine-Portfolio-Consumption, Conceptual-Debate-Victory, The-Grand-Game.

## [2026-08-04] ingest | Aizen God Campaign — Chat 1, Entries 1-300

Key claims: Player restarted the "bane - main" Gemini campaign as "The Shadow over the Gate" (D&D 5e, Baldur's Gate) via a clean-slate restart keeping characters/factions but resetting state. Five factions: Flaming Fist (Ulder Ravengard), The Guild, Knights of the Shield, Cult of the Dead Three (Bane as subtle presence — continuity with the predecessor chat), and new faction House Aizen led by Sosuke Aizen. Opening "A Night of Unrest" offers four intertwining PC hooks all bearing Aizen's off-screen fingerprint (unusual antagonist efficiency, eye sigil). New entities: SosukeAizen, HouseAizen, FlamingFist, UlderRavengard, TheGuildBaldursGate, KnightsOfTheShield, CultOfTheDeadThree, BaldursGate. New concepts: CleanSlateCampaignRestart, SubtleInfluenceCampaignHook.

## [2026-08-04] ingest | Aizen god campaign chat 1, entries 601-900 — Knights of the Shield confrontation

Key claims: Aizen Sosuke (L12, CHA 23) bypasses Knights of the Shield wards with Knock and preempts interrogation with a manufactured truth narrative: parents Corvan and Seraphina Sosuke ran the Grand Conjunction to manifest Bane, Bane betrayed them, Corvan died, Seraphina fled with a counter-ritual; Aizen and brother Malachi purge cultist hubs. Setting: Baldur's Gate, 1492 DR, Flamerule 12. New entities: AizenSosuke, KnightsOfTheShield, Bane, CorvanSosuke, SeraphinaSosuke, MalachiSosuke, BaldursGate. New concepts: ManufacturedTruthNarrative, GrandConjunction. All plot details flagged as Aizen's account, not ground truth.

## [2026-08-04] ingest | Aizen god campaign chat 1 (entries 301-600) — Level 10 ascension and Destiny Rulebook stats

Key claims: Aizen (Human Paladin 2/Bard 8, Neutral Evil, Child of Bane) advances Level 9→10 via a player-directed 7,340 XP grant; second ASI takes CHA to 23 (+6) via triple-stacked bonuses (base + Bane heritage + Holy Armor + ASI); Locate Creature learned at Bard 8. 'add itg' typo briefly misparsed as an Infernal Taint custom mechanic before clarification. Documents homebrew DestinyRulebookOverrides defense stats (ED 20, DR 7, AR 20, Armor Mitigation 10) coexisting with standard AC 18. Entities: Aizen, Bane. Concepts: PlayerDirectedExpGrant, DestinyRulebookOverrides. Contradiction flagged: HP 59 asserted without recalculation at level-up.

## [2026-08-04] ingest | Ains — Sanctuary of Flesh and Shadow campaign module v2

Key claims: Overlord × D&D 5e/Pathfinder hybrid isekai campaign; 16-year-old living lich Ains manages Nazarick with L12-16 guardian ceiling; core mechanics: Sanctuary Imperative (psychic strain tracks moral weight), Mask of Fragility (dynamic deception DC), Whispers of the Realm (narrative aggro). Universal Sentience + Lone Sovereign constraints drive tension. Session 1: Treasury Audit opening scene.

Entities created: [[Ains-Ooal-Gown]], [[Nazarick]], [[Demiurge]], [[Shalltear Bloodfallen]], [[Sebas Tian]]

Concepts created: [[Sanctuary Imperative]], [[Mask of Fragility]], [[Whispers of the Realm]], [[Lone Sovereign Constraint]], [[Universal Sentience]]
...
## [2026-08-04] ingest | House of the Dragon — Custom Campaign Template for WorldArchitect.AI

Key claims: public-friendly standalone port of the Visenya v7 bastard framing, scoped for paste-into-WorldArchitect.AI. Protagonist: gender-ambiguous 16yo bastard of Prince [[DaemonTargaryen]] and a dead Targaryen lady (GreatBastard — dragonlord blood on both sides), just claimed a medium she-dragon at the start of the [[DanceOfTheDragons]]; L6 custom "Dragonrider Aristocrat" gestalt (Fighter HP + Rogue Sneak Attack progression), signature ability DragonsBond (Adult Dragon companion, ~195 HP, shared senses + telepathic voice + mounted combat), and a per-session "Blood of the Dragon" compulsion mechanic (bonus action on royal-blood proof; 3+ uses = DC 12 Wis save or Exhaustion). The 9-section bible follows the [[CampaignBibleNineSectionStructure]] from the [[SovereignSoloCampaignGenerator]] meta-prompt. Setup walkthrough verified live against `worldarchitect.ai` (Custom Campaign wizard, 2 steps; Custom is default-selected; description-input accepts ≥15K characters; use-default-world must be unchecked for ASOIAF). Includes an LLM-edit meta-prompt for player customization before pasting. Sister page: `wiki/campaigns/HouseOfTheDragon.md` in the WorldArchitect.AI repo (public-facing wiki page that shows how to set up the campaign).
...
## [2026-09-06] ingest | Fable missing from Claude Code /model picker is an upstream bug
`~/.claude/settings.json` had a correct `modelPicker.options` entry for the real, catalog-registered `claude-fable-5-1`, but v2.1.259's `/model` picker never listed it, even in a fresh tmux session. Direct testing found: `claude --model fable` works immediately with full entitlement, and the picker THEN lists it fully inside that session — the picker only offers the fixed GA lineup plus the session's launch-time active model, never injecting `modelPicker.options` rows for non-active models. Confirmed as a known, unresolved upstream defect by fetching 8 real anthropics/claude-code GitHub issues via `gh api` (not just WebSearch summary text): #66827 (server-pushed policy-limits.json flag, local override reverted by server), #73423, #73333 (identical picker-disabled-but-flag-works pattern across users/OSes), #82797 (Team Premium seat still blocked). All closed by inactivity-bot, never fixed. New concepts [[ClaudeCodeModelPickerEntitlementGap]], [[VerifyUpstreamBugClaimsViaLiveAPI]]. Bead `rev-xch9w`.
Does not affect [[jeffrey-oracle]]
...
## [2026-09-06] ingest | Advice runner LFS smudge bug (fixed) + concurrent-session merge race
`create_clone()` in `~/.claude/skills/advice/scripts/run_primary_pair.py` removed `origin` before `git checkout`, breaking Git LFS smudge downloads (100% reproducible exit 128, "missing protocol") for any reviewed SHA whose tree reaches an LFS blob; fixed via `GIT_LFS_SKIP_SMUDGE=1` on the clone and checkout subprocess calls. Also hardened `/advice`'s receipt durability (immediate `running` receipt with pid/boot_identity, per-lane publish via `as_completed`, persistent `~/.claude/state/advice/runs/` output dir instead of `/tmp`). Separately: while driving PR #9743 through `/ready`, a different concurrent session on the same account squash-merged that exact PR without this session calling `gh pr merge` — extended [[SameAuthorConcurrentSessionCollision]] with this merge-race variant. New concepts [[AdviceRunner]], [[GitLfsSmudgeFilter]]. Bead `rev-ot94l`.
Does not affect [[jeffrey-oracle]]

## [2026-09-07] ingest | /integrate hard-stopped on a live concurrent-session collision
Ran `/integrate` in `worktree_beads_fix_again` after unrelated beads-harness work (PR #9459/#9765/#9766). `integrate.sh` correctly hard-stopped on uncommitted changes, but they belonged to a different, live concurrent session sharing the same worktree (a `.claude/hooks` archive rename set plus two-tier-core-memory research docs) — not this session's own drift. `lsof +D <worktree>` showed live `claude.ex`/`aside`/`bash`/`node` processes holding the directory open; a repeated `git diff -- CLAUDE.md` returned different output seconds apart, proving active concurrent editing. Added a new sub-case to [[IntegrateHardStopPattern]] and cross-linked [[SameAuthorConcurrentSessionCollision]] (same hazard class, one layer down: filesystem instead of PR/merge). Rule: before treating a hard-stop's uncommitted state as yours to resolve, run `lsof +D <path>` and re-check `git status`/`git diff` twice a few seconds apart; never `--force` or manually commit/stash unrecognized changes. Bead `rev-x93bo` (closed).
Does not affect [[jeffrey-oracle]]

## [2026-09-08] ingest | Successful /integrate includes mandatory /learn
After a successful `/integrate`, the agent skipped `/learn` because the `learn` skill was read as requiring a separate memory-write authorization that it treated as missing. User corrected in-thread: a request to run `/integrate` includes its required post-success `/learn` workflow; inventing a separate approval gate and silently skipping it is the bug. An explicit no-memory instruction or higher-priority storage restriction still overrides the step, and any blocked target must be reported individually — a chat summary alone is not proof learning was captured. Fix targets `~/.claude/skills/integrate/SKILL.md`'s skip-on-missing-approval clause, replacing it with a mandatory post-integration learning step, verified against the tracked export source with a `user_scope` backup kept. Same failure shape as [[SkillStaleness]] (the skill's own gate logic, not the underlying mechanism, was wrong). Cross-linked [[IntegrateHardStopPattern]] and [[IntegrateSh]].
Does not affect [[jeffrey-oracle]]
