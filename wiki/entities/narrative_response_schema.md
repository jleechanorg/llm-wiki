...
`narrative_response_schema.py` is a Python module containing the [NarrativeResponse](NarrativeResponse.md) Pydantic schema and validation functions for structured LLM responses.
...
## Validation
The module implements strict tier validation for [SocialHPChallenge](../concepts/SocialHPChallenge.md):
