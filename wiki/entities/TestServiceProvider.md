...
## Implementations
- [RealServiceProvider](RealServiceProvider.md) — real implementation creating actual Google clients
- Mock test provider — mocked implementation for isolated testing

## Related
- [RealServiceProvider](RealServiceProvider.md) — implements this interface
